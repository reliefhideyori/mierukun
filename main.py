...
async def extract_ideas(req: Request):
    ...
    prompt = (
        ...
        "- categoryは以下の6つのいずれかを必ず使用する：\n"
        "  アイデア / リスク / 検討すべきこと / 決定事項 / アクションアイテム / 意見・フィードバック\n"
        "  （新機能・改善案→アイデア、懸念・障壁→リスク、未解決議題→検討すべきこと、"
        "  合意済み事項→決定事項、担当者付きタスク→アクションアイテム、感想・提言→意見・フィードバック）\n"
        "- tagsは2〜3個\n\n"
